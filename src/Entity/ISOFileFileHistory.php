...
#[ORM\Table(name: "iso_file_file_history")]
#[ORM\Entity]
#[ORM\HasLifecycleCallbacks]
#[ORM\Cache(usage: "NONSTRICT_READ_WRITE")]
#[Gedmo\Loggable(logEntryClass: LogDbTracking::class)]
class ISOFileFileHistory
{
    ...
    #[ORM\ManyToOne(inversedBy: "ISOFileFileHistory")]
    ...
    public function getISOFile(): ?ISOFile
    {
        return $this->ISOFile;
    }

    public function setISOFile(?ISOFile $ISOFile): self
    {
