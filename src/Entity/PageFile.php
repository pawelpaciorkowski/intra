...
#[ORM\Entity(repositoryClass: PageFileRepository::class)]
#[ORM\HasLifecycleCallbacks]
#[ORM\Cache(usage: "NONSTRICT_READ_WRITE")]
#[Gedmo\Loggable(logEntryClass: LogDbTracking::class)]
class PageFile implements IndexInterface
{
    ...
    #[ORM\ManyToOne(inversedBy: "PageFiles")]
    #[JoinColumn]
    private ?PageCategory $pageCategory = null;

    #[Assert\File(maxSize: '128M', extensions: [
        'pdf',
        'doc',
        'docx',
        'xls',
    ...
    #[ORM\OneToMany(targetEntity: "PageFileFileHistory", mappedBy: "pageFile")]
    #[ORM\OrderBy(["createdAt" => "desc"])]
    private Collection $pageFileFileHistory;

    #[ORM\ManyToMany(targetEntity: Tag::class, cascade: ['persist'])]
    #[ORM\JoinTable(name: 'page_files_tags')]
    ...
    public function __construct()
    {
        $this->isActive = false;
        $this->sort = 0;
        $this->pageFileFileHistory = new ArrayCollection();
    ...
    public function addPageFileFileHistory(PageFileFileHistory $pageFileFileHistory): self
    {
        $this->pageFileFileHistory[] = $pageFileFileHistory;

        return $this;
    }

    public function removePageFileFileHistory(PageFileFileHistory $pageFileFileHistory): void
    {
        $this->pageFileFileHistory->removeElement($pageFileFileHistory);
    }

    public function getPageFileFileHistory(): ?Collection
    {
        return $this->pageFileFileHistory;
    }

    public function getFileHistory(): ?Collection
    {
        return $this->getPageFileFileHistory();
    }
