...
class ParameterBag implements ParameterBagInterface
{
     ...
     * {@inheritdoc}
     */
    public function get(string $name): array|bool|string|int|float|object|null
    {
     ...
     * {@inheritdoc}
     */
    public function set(string $name, array|bool|string|int|float|object|null $value): void
    {
