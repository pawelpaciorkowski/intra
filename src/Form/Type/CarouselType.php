...
final class CarouselType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add(
                ...
                PhotoType::class,
                [
                    'help' => 'Docelowa rozdzielczość 1170x585. Zdjęcie przesłane w innych proporcjach zostanie przycięte do rozdzielczości docelowej.',
                ]
            )
            ->add(
                'title',
    ...
    {
        $resolver->setDefaults(['data_class' => Carousel::class]);
    }
}
