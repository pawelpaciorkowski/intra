 ...
 */
final class Version20240904200714 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE iso_file_file_history ADD CONSTRAINT FK_A481361D3AACD9 FOREIGN KEY (isofile_id) REFERENCES iso_files (id) ON DELETE CASCADE');
